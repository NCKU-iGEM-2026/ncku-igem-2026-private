(function () {
  ...
  var PAGES = {
    ...
    engineering:   { section: 'wet',     tags: { build: 2, think: 2, data: 1 } },
    ...
    'online-game': { section: 'project', tags: { play: 3, talk: 1 } },
    ...
    en: {
      ...
      pages: {
        ...
        'online-game': ['Online Game',
          'A timed game you can play here in the browser.'],
